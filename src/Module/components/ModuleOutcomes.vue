      ...
      <div class="module-outcomes__items">
        ...
        <div class="module-outcomes__dropdown">
          <v-menu offset-y top>
            ...
            <v-list>
              <v-list-item v-for="(op, index) in minutesReq" :key="index" @click="minReq = op">
        ...
        <div class="module-outcomes__dropdown">
          <v-menu offset-y top>
            ...
            <v-list>
              <v-list-item v-for="(op, index) in minutesNec" :key="index" @click="goal = op">
                <v-list-item-title>{{ op }}</v-list-item-title>
              </v-list-item>
            </v-list>
          </v-menu>
...
export default Vue.extend({
  ...
  data: () => ({
    minutesReq: ['10m', '20m', '30m', '45m', '60m'],
    minutesNec: ['100m', '200m', '300m', '400m', '500m', '600m', '700m', '800m', '900m', '1000m'],
    minReq: 'Select',
    goal: 'Select'
  })
});
